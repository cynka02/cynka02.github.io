...
<body onload="load()">
	#<div>Letters: <span id="ClickDiv">0.00</span></div><br />
	#<div>Letters per second: <span id="PerSecond">0.00</span></div><br />
	#<button onclick="LettersCountTracker()" id="ClickButton">+ 1</button><br />
