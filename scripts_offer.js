...
function load(){
    if (JSON.parse(localStorage.getItem('lang'))){
        ...
        if (lang){ // polski
            ...
            document.getElementById("menu3").innerHTML ='<a href="index.html#info2">Partnerzy</a>';
            document.getElementById("menu2").innerHTML ='Oferta';
            document.getElementById("offer_main").innerHTML ='Oferta';
